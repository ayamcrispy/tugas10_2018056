...
import static com.example.tugas5_recyclerview.DBmain.TABLENAME;
...
import com.example.tugas5_recyclerview.databinding.ActivityMain3Binding;
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long rec = sqLiteDatabase.insert("barang", null, cv);
                if (rec != null) {
